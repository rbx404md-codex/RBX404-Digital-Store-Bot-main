...
CREATE TABLE IF NOT EXISTS force_join_channels (
    ...
    chat_type   TEXT NOT NULL DEFAULT 'channel',   -- 'channel' | 'group'
    is_required INTEGER NOT NULL DEFAULT 1,        -- 1 = mandatory, 0 = optional
    is_active   INTEGER NOT NULL DEFAULT 1
);

CREATE TABLE IF NOT EXISTS referral_milestones (
    milestone_id  INTEGER PRIMARY KEY AUTOINCREMENT,
    threshold     INTEGER NOT NULL,      -- number of ACTIVE referrals needed
...
async def init_db() -> None:
    ...
    async with aiosqlite.connect(DB_PATH) as db:
        ...
        try:
            await db.execute("ALTER TABLE products ADD COLUMN is_featured INTEGER NOT NULL DEFAULT 0")
        ...
        for statement in (
            ...
            "ALTER TABLE force_join_channels ADD COLUMN chat_type TEXT NOT NULL DEFAULT 'channel'",
            "ALTER TABLE force_join_channels ADD COLUMN is_required INTEGER NOT NULL DEFAULT 1",
            "ALTER TABLE referrals ADD COLUMN reminder_count INTEGER NOT NULL DEFAULT 0",
            "ALTER TABLE referrals ADD COLUMN last_reminder_at TEXT",
        ):
            try:
